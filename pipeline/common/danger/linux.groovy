...
//                    currentBuild.description += """<br><a href="http://localhost/jenkins/tuucho-report/${repository.relativePath()}/project/tuucho/build/reports/ktlint/index.html" target="_blank">KtLint</a>"""
                }
            }
        }
